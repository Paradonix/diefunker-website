...
if (isset($_SESSION['userId'])) {
    ...
    <html>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="css/raids.css">

            <!--
            <link rel="stylesheet" type="text/css" href="css/raids-alternate.css">
            -->

            <link rel="icon" href="../images/icon.ico">
            <script type="text/javascript" src="collapsible.js"></script>
            <script src="skript/raids.js"></script>
            <script src="../skript/main.js"></script>
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
            <script src="editTextRai.js"></script>
        </head>
                ...
                <div class="menu-wrapper" id="menu-expand">
                    ...
                    <nav class="menu">
                        <ol>
                            ...
                            <li class="menu-item"><a href="">Raids</a></li>
