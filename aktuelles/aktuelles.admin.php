<?php
    ...
    $aktuelles = $column['aktuellesText'];
...
if (isset($_SESSION['userId'])) {
    ...
    <html>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="css/aktuelles.css">

            <!--
            <link rel="stylesheet" type="text/css" href="css/aktuelles-alternate.css">
            -->

            <link rel="icon" href="../images/icon.ico">
            <script src="../skript/main.js"></script>
            <script src="skript/aktuelles.js"></script>
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
            <script src="editTextAkt.js"></script>
        </head>
        ...
        <body>
            <div class="wrapper">
                <div class="menu-wrapper" id="menu-expand">
                    ...
                    <nav class="menu">
                        <ol>
                            <li class="menu-item"><a href="">Aktuelles</a></li>
