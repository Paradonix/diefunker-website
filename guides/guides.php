...
<html>
    ...
    <body>
        <div class="wrapper">
                    ...
                    <ol>
                        ...
                        if (isset($_SESSION['userId'])) {
                            ...
                            <li class="menu-item dropdown">
                                <a href="">Guides</a>
                                <ol class="sub-menu">
                                    <li class="menu-item"><a href="raid-guides/raid-guides">Raid Guides</a></li>
            ...
            <h1>Guides</h1>
            <figure class="guide-img raid-img">
                <img src="../images/raid.jpg"/>
                <figcaption>
                    <div>
                        <h2><span>Raid</span> Guides</h2>
                    </div>
                    <div>
                        <p>Coming Soon</p>
                    </div>
                    <a href="raid-guides/raid-guides"></a>
                </figcaption>
            </figure>
            <figure class="guide-img fraktal-img">
                <img src="../images/fraktal.jpg"/>
                <figcaption>
                    <div>
                        <h2><span>Fraktal</span> Guides</h2>
                    </div>
                    <div>
                        <p>Coming Soon</p>
                    </div>
                    <a href="fraktal-guides/fraktal-guides"></a>
                </figcaption>
            </figure>
            <figure class="guide-img anfaenger-img">
                <img src="../images/anfaenger.jpg"/>
                <figcaption>
                    <div>
                        <h2><span>Anfänger</span> Guides</h2>
                    </div>
                    <div>
                        <p>Coming Soon</p>
                    </div>
                    <a href="anfaenger-guides/anfaenger-guides"></a>
                </figcaption>
            </figure>
        </div>
